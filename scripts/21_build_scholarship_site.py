...
<h3 style="font-family:var(--font-serif);font-size:1rem;color:var(--accent);margin:1.5rem 0 .5rem">Agrippa as Humanist Theologian</h3>

<p>The book's governing characterization of Agrippa as a "humanist theologian" draws on a specific understanding of what Renaissance humanism meant as a theological programme. The Erasmian <em>philosophia Christi</em> — the return to scripture and the early church fathers as the authoritative sources for Christian doctrine, combined with a critique of scholastic elaboration as a corruption of genuine theology — provides the framework. Agrippa, on Van der Poel's reading, is an Erasmian in theology: he distrusts Aristotelian syllogistic in theology, insists on the priority of scripture over scholastic commentary, and believes that the truest Christian wisdom is available not through philosophical reasoning but through scriptural meditation and evangelical simplicity.</p>

<p>This theological orientation explains what might otherwise appear to be a contradiction in Agrippa's career: how the author of a vast compendium of occult philosophy can also be the author of a work denouncing all human learning as vanity. On Van der Poel's reading, there is no contradiction: the <em>DOP</em> represents Agrippa's most ambitious attempt to systematize a legitimate form of natural and divine knowledge (occult philosophy), while <em>De incertitudine</em> represents his most ambitious declamatory exercise in demonstrating the limits of all human systematic knowledge. Both works serve the same theological programme: the establishment of experiential, scriptural, and evangelical knowledge against the pretensions of scholastic rationalism.</p>
